...
import org.springframework.social.skplanetx.connect.SkplanetxConnectSupport;
...
public class SkplanetxSignInController extends ProviderSignInController implements InitializingBean{
    ...
    private SkplanetxConnectSupport connectSupport;
    ...
    public void afterPropertiesSet() throws Exception {
        this.connectSupport = new SkplanetxConnectSupport(sessionStrategy);
